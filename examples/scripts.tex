...
\newcommand\textlatin[1]{\bgroup\textdir TLT #1\egroup}
  ...
  \begin{document}
  \font\arab={Scheherazade:+language=ara;+script=arab;} at 12pt
\arab 
  \startharfbuzz
%  
...
\font\notourdu={Noto Nastaliq Urdu:+script=arab;+language=URD} at 12pt
\notourdu
...
\font\lohit={Lohit Tamil:+script=tami;+language=TAM} at 12pt
\lohit
